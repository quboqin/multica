...
const (
	...
	// CortexCollections gates the isolated T2 collection/record slice. It is
...
func CortexCollectionsEnabled(ctx context.Context, flags *featureflag.Service) bool {
	return flags.IsEnabled(ctx, CortexCollections, false)
}
